...
public class FragUtil32 {
     ...
     */
    public static int fragGetTrue(int src, int frag) {
        return src | frag;
    }
     ...
     */
    public static int fragGetFalse(int src, int frag) {
        return src & ~frag;
    }

    public static int fragSet(int src, int frag, boolean is) {
        if (is) return fragGetTrue(src, frag);
        else return fragGetFalse(src, frag);
    }
}
